...
const config = {
  ...
  themeConfig: {
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: 'GitHub',
              href: 'https://github.com/jVXgHcey',
            },
            // {
            //   label: '掘金',
      ...
      copyright: `<p><a href="http://beian.miit.gov.cn/" >${beian}</a></p><p>Copyright © 2020 - PRESENT 西蒙 Built with Docusaurus.</p>`,
    },
    prism: {
    ...
    socials: {
      github: 'https://github.com/jVXgHcey',
      qq: 'https://wpa.qq.com/msgrd?v=3&amp;uin=710394000&amp;site=qq',
      cloudmusic: 'https://music.163.com/#/user/home?id=476700046',
    },
  },
  headTags: [
    {
